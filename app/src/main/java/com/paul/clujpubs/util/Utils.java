package com.paul.clujpubs.util;
...
import com.paul.clujpubs.CPApplication;
...
public class Utils {
    ...
    public static boolean initializeLibrary(final Activity context) {
        ...
        final String  mapResourcesPath = ((CPApplication)context.getApplicationContext()).getAppPrefs().getStringPreference("mapResourcesPath");
...
//         + "/PreinstalledMaps");
    ...
    public static void showApiKeyErrorDialog(Activity currentActivity) {
        ...
        alertDialog.setPositiveButton(
                currentActivity.getResources().getString(com.skobbler.ngx.R.string.ok_label),
