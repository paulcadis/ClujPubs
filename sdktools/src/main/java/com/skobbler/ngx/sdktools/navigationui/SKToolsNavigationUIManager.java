...
class SKToolsNavigationUIManager {
    ...
    private void hideNavigationOrFreeDrivePanels() {
        ...
        hideViewIfVisible(searchingForGPSPanel);
    ...
    protected void removeNavigationViews() {
        ...
        if (searchingForGPSPanel != null) {
            rootLayout.removeView(searchingForGPSPanel);
            searchingForGPSPanel = null;
        }
    }
